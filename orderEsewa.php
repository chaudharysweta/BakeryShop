...
if(isset($_POST['submit']))
{
    ...
    $status="Payment with eSewa"; //ordered,on delivery,delevered,cancelled
    ...
    if($res2==true)
    {
        ...
        header('location:http://localhost/BAKERYSHOP/Esewa/index.php');
    }
    else
    {
        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <input type="submit" name="submit" value="Pay With eSewa" class="btn btn-primary">
